      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {stories.length} Geschichten insgesamt
            </p>
          </div>
        ...
        {loading ? (
          <div className="text-center py-16">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">Lade Geschichten...</p>
          </div>
        ) : stories.length === 0 ? (
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      ...
                      title={story.published ? "Ansehen (Live)" : "Vorschau ansehen"}
                    >
                    ...
                    <button
                      ...
                      title={story.published ? "Verstecken" : "Veröffentlichen"}
                    >
